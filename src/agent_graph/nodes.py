...
Provide exactly three nonblank string tags and one nonblank summary of at most 25
...
nonblank string tags, a nonblank summary of at most 25 whitespace-delimited words,
topical relevance, and no unsupported factual claims.
